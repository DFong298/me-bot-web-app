...
if st.session_state["intro_visible"]:
    st.markdown("Hi! You have found an AI chat bot imitation of me. This is only AI, so don't take what it says too seriously! Type something to get started :slightly_smiling_face:")
